...
ISEStep( "vivado",
         "-log zybo_design_axis_subset_converter_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_design_axis_subset_converter_0_2.tcl" );
