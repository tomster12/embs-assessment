...
HD_PWD='/home/tomster12/files/EMBS/vivado/vivado.runs/zybo_design_xbar_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_xbar_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_design_xbar_3.tcl
