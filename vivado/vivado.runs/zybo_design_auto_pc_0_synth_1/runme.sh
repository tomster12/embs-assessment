...
HD_PWD='/home/userfs/t/tb1262/Files/EMBS/embs-assessment/vivado/vivado.runs/zybo_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_design_auto_pc_0.tcl
