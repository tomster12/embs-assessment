...
HD_PWD='/home/userfs/t/tb1262/Files/EMBS/embs-assessment/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_design_wrapper.tcl
