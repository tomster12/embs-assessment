...
HD_PWD='/home/userfs/t/tb1262/Files/EMBS/embs-assessment/vivado/vivado.runs/zybo_design_toplevel_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_toplevel_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_design_toplevel_0_4.tcl
