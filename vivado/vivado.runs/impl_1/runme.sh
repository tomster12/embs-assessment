...
HD_PWD='/home/userfs/t/tb1262/Files/EMBS/embs-assessment/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_design_wrapper.tcl -notrace
