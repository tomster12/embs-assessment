...
# Path of this script: /home/tomster12/files/EMBS/vitis/assessment_system/_ide/scripts/assessment_system_(remote)_standalone.tcl
# 
# 
# Usage with xsct:
...
# source /home/tomster12/files/EMBS/vitis/assessment_system/_ide/scripts/assessment_system_(remote)_standalone.tcl
# 
connect -path [list tcp::1534 tcp:localhost:12345]
targets -set -nocase -filter {name =~"APU*"}
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Zybo Z7 210351A7800AA" && level==0 && jtag_device_ctx=="jsn-Zybo Z7-210351A7800AA-13722093-0"}
