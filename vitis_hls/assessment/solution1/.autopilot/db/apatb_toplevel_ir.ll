...
entry:
  ...
  %0 = bitcast i32* %ram to [7827 x i32]*
  call fastcc void @copy_in([7827 x i32]* %0, [7827 x i32]* %ram_copy, i32* %code, i32* nonnull align 512 %code_copy)
  %1 = getelementptr inbounds [7827 x i32], [7827 x i32]* %ram_copy, i32 0, i32 0
  call void @apatb_toplevel_hw(i32* %1, i32* %code_copy)
  call fastcc void @copy_out([7827 x i32]* %0, [7827 x i32]* %ram_copy, i32* %code, i32* nonnull align 512 %code_copy)
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr.gep1 = getelementptr [7827 x i32], [7827 x i32]* %0, i64 0, i64 %for.loop.idx3
  %5 = bitcast i32* %dst.addr.gep1 to i8*
  %src.addr.gep2 = getelementptr [7827 x i32], [7827 x i32]* %1, i64 0, i64 %for.loop.idx3
  %6 = bitcast i32* %src.addr.gep2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 %6, i64 4, i1 false)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx3, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 7827
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([7827 x i32]*, [7827 x i32]* noalias readonly, i32*, i32* noalias readonly align 512) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a7827i32([7827 x i32]* %0, [7827 x i32]* %1)
...
entry:
  %2 = bitcast i32* %0 to [7827 x i32]*
  call void @copy_out([7827 x i32]* null, [7827 x i32]* %2, i32* null, i32* %1)
  %3 = bitcast [7827 x i32]* %2 to i32*
  call void @toplevel_hw_stub(i32* %3, i32* %1)
  call void @copy_in([7827 x i32]* null, [7827 x i32]* %2, i32* null, i32* %1)
  ret void
}
