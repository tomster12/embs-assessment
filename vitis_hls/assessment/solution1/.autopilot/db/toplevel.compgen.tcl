...
set out_width 18
set exp i0*i1
set arg_lists {i0 {16 0 +} i1 {9 0 +} p {18 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set out_width 18
set exp i0*i1+i2
set arg_lists {i0 {16 0 +} i1 {9 0 +} m {18 0 +} i2 {9 0 +} p {18 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler toplevel_control_s_axi
}
