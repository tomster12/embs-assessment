...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.toplevel.autotvin_MAXI.dat"
         "c.toplevel.autotvin_ram.dat"
         "c.toplevel.autotvout_MAXI.dat"
         "c.toplevel.autotvout_code.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.toplevel.autotvout_MAXI.dat"
         "rtl.toplevel.autotvout_code.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
