...
if {[file isfile toplevel.autotvin.dat]} {
	file delete -force toplevel.autotvin.dat
}

if {[file isfile toplevel.autotvout.dat]} {
	file delete -force toplevel.autotvout.dat
}
