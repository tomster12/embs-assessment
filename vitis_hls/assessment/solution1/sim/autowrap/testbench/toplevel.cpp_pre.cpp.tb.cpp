...
// ==============================================================
# 1 "/home/tomster12/files/EMBS/vitis_hls/assessment/toplevel.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
extern "C"
#endif
void apatb_toplevel_ir(unsigned int *, volatile unsigned int *);
#ifdef __cplusplus
extern "C"
#endif
void toplevel_hw_stub(unsigned int *ram, volatile unsigned int *code){
toplevel(ram, code);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_toplevel_sw(unsigned int *ram, volatile unsigned int *code){
apatb_toplevel_ir(ram, code);
return ;
}
#endif
